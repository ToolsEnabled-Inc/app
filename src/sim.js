// The living fleet — a deterministic-feeling simulation that drives every view.
// Nothing here touches the real system; it only needs to look true.
...
function mkComputer({ id, name, ip, note, epochOffset }) {
...
class Sim {
  ...
  mkMetrics() {
    ...
    return {
      ...
      spend: { vertexRemaining: 261.4, vertexTotal: 298, subSeatPct: 71, uniPct: 4 },
    }
  }
